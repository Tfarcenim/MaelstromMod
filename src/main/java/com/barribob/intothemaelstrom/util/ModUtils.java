...
import com.barribob.intothemaelstrom.entity.entities.EntityMaelstromHealer;
...
import com.barribob.intothemaelstrom.invasion.InvasionWorldSaveData;
...
public final class ModUtils {
    ...
    public static void handleAreaImpact(float radius, Function<Entity, Double> maxDamage, Entity source, Vec3d pos, DamageSource damageSource) {
    ...
    public static void handleBulletImpact(Entity hitEntity, ProjectileEntity projectile, double damage, DamageSource damageSource) {
        handleBulletImpact(hitEntity, projectile, damage, damageSource, 0);
    }

    public static void handleBulletImpact(Entity hitEntity, ProjectileEntity projectile, double damage, DamageSource damageSource, int knockback) {
    ...
    public static void handleBulletImpact(Entity hitEntity, ProjectileEntity projectile, double damage, DamageSource damageSource, int knockback,
                                          BiConsumer<ProjectileEntity, Entity> beforeHit, BiConsumer<ProjectileEntity, Entity> afterHit) {
        handleBulletImpact(hitEntity, projectile, damage, damageSource, knockback, beforeHit, afterHit, true);
    }

    public static void handleBulletImpact(Entity hitEntity, ProjectileEntity projectile, double damage, DamageSource damageSource, int knockback,
                                          BiConsumer<ProjectileEntity, Entity> beforeHit, BiConsumer<ProjectileEntity, Entity> afterHit, Boolean resetHurtTime) {
        if (hitEntity != null && projectile != null && projectile.shootingEntity != null && hitEntity != projectile.shootingEntity) {
            ...
            hitEntity.attackEntityFrom(damageSource, (float) damage);
            if (knockback > 0) {
    ...
    public static void throwProjectile(EntityLivingBase actor, EntityLivingBase target, ProjectileEntity projectile) {
        throwProjectile(actor, target, projectile, 12.0f, 1.6f);
    }

    public static void throwProjectile(EntityLivingBase actor, Vec3d target, ProjectileEntity projectile, float inaccuracy, float velocity, Vec3d offset) {
    ...
    public static void throwProjectile(EntityLivingBase actor, EntityLivingBase target, ProjectileEntity projectile, float inaccuracy, float velocity, Vec3d offset) {
        Vec3d pos = projectile.getPositionVector().add(offset);
        projectile.setPosition(pos.x, pos.y, pos.z);
        throwProjectile(actor, target, projectile, inaccuracy, velocity);
    }

    public static void throwProjectile(EntityLivingBase actor, EntityLivingBase target, ProjectileEntity projectile, float inaccuracy, float velocity) {
    ...
    public static void throwProjectile(EntityLivingBase actor, Vec3d target, ProjectileEntity projectile, float inaccuracy, float velocity) {
        throwProjectileNoSpawn(target, projectile, inaccuracy, velocity);
        actor.world.spawnEntity(projectile);
    }

    public static void throwProjectileNoSpawn(Vec3d target, ProjectileEntity projectile, float inaccuracy, float velocity) {
        double d0 = target.y;
