...
public class ProjectileEntityMeteor extends ProjectileEntityGun {
    private static final int PARTICLE_AMOUNT = 15;
    private static final int EXPOSION_AREA_FACTOR = 6;

    public ProjectileEntityMeteor(World worldIn, EntityLivingBase throwerIn, double baseDamage, ItemStack stack) {
        super(worldIn, throwerIn, baseDamage, stack);
        this.setNoGravity(true);
    }

    public ProjectileEntityMeteor(World worldIn) {
        super(worldIn);
        this.setNoGravity(true);
    }

    public ProjectileEntityMeteor(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
        this.setNoGravity(true);
    }
