 ...
 */
public class ProjectileEntityPumpkin extends ProjectileEntityGun {
    ...
    public ProjectileEntityPumpkin(World worldIn, EntityLivingBase throwerIn, float baseDamage, ItemStack stack) {
        super(worldIn, throwerIn, baseDamage, stack);
        this.prevPos = this.getPositionVector();
    }

    public ProjectileEntityPumpkin(World worldIn) {
        super(worldIn);
        this.prevPos = this.getPositionVector();
    }

    public ProjectileEntityPumpkin(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }
