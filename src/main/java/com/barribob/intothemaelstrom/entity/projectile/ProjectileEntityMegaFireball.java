 ...
 * @author Barribob
 */
public class ProjectileEntityMegaFireball extends ProjectileEntityAbstractMegaFireball {
    ...
    public ProjectileEntityMegaFireball(World worldIn, EntityLivingBase throwerIn, double baseDamage, ItemStack stack, boolean canTakeDamage) {
        super(worldIn, throwerIn, baseDamage, stack, canTakeDamage);
    }

    public ProjectileEntityMegaFireball(World worldIn) {
        super(worldIn);
    }

    public ProjectileEntityMegaFireball(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(@Nullable RayTraceResult result) {
        ...
        if(!world.isRemote) {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                ProjectileEntityFireball shrapenel = new ProjectileEntityFireball(world, shootingEntity, this.getDamage() * 0.5f, null);
