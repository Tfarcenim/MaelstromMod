...
public class ProjectileEntityBlackFireball extends ProjectileEntity {
    ...
    public ProjectileEntityBlackFireball(World worldIn, EntityLivingBase throwerIn, double baseDamage) {
        super(worldIn, throwerIn, baseDamage);
        this.setNoGravity(true);
    }

    public ProjectileEntityBlackFireball(World worldIn) {
        super(worldIn);
        this.setNoGravity(true);
    }

    public ProjectileEntityBlackFireball(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
        this.setNoGravity(true);
    }
