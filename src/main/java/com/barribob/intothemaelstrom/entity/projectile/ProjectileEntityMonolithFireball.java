...
public class ProjectileEntityMonolithFireball extends ProjectileEntityGun {
    private static final int EXPOSION_AREA_FACTOR = 2;
    public static final Vec3d FIREBALL_COLOR = new Vec3d(1.0, 0.6, 0.5);

    public ProjectileEntityMonolithFireball(World worldIn, EntityLivingBase throwerIn, double baseDamage, ItemStack stack) {
        super(worldIn, throwerIn, baseDamage, stack);
        this.setNoGravity(true);
    }

    public ProjectileEntityMonolithFireball(World worldIn) {
        super(worldIn);
        this.setNoGravity(true);
    }

    public ProjectileEntityMonolithFireball(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
        this.setNoGravity(true);
    }
