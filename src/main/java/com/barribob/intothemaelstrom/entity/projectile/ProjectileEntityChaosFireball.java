...
public class ProjectileEntityChaosFireball extends ProjectileEntityGun {
    ...
    public ProjectileEntityChaosFireball(World worldIn, EntityLivingBase throwerIn, double baseDamage, ItemStack stack) {
        super(worldIn, throwerIn, baseDamage, stack);
        this.setNoGravity(true);
    }

    public ProjectileEntityChaosFireball(World worldIn) {
        super(worldIn);
        this.setNoGravity(true);
    }

    public ProjectileEntityChaosFireball(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
        this.setNoGravity(true);
    }
