...
public class ProjectileEntityFireball extends ProjectileEntityGun {
    ...
    public ProjectileEntityFireball(World worldIn, EntityLivingBase throwerIn, double baseDamage, ItemStack stack) {
        super(worldIn, throwerIn, baseDamage, stack);
        this.setNoGravity(true);
    }

    public ProjectileEntityFireball(World worldIn) {
        super(worldIn);
        this.setNoGravity(true);
    }

    public ProjectileEntityFireball(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
        this.setNoGravity(true);
    }
