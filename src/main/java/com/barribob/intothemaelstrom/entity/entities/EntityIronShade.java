...
import com.barribob.intothemaelstrom.entity.action.ActionSpinSlash;
...
import com.barribob.intothemaelstrom.entity.model.ModelIronShade;
...
public class EntityIronShade extends EntityMaelstromMob {
    ...
    protected void initAnimation() {
        List<List<AnimationClip<ModelIronShade>>> flipAnimations = new ArrayList<>();
        List<AnimationClip<ModelIronShade>> wisps = new ArrayList<>();
        List<AnimationClip<ModelIronShade>> arms = new ArrayList<>();
        List<AnimationClip<ModelIronShade>> body = new ArrayList<>();
        List<AnimationClip<ModelIronShade>> lowerChains = new ArrayList<>();
        List<AnimationClip<ModelIronShade>> upperChains = new ArrayList<>();

        BiConsumer<ModelIronShade, Float> bodyFlipper = (model, f) -> {
            model.wisps.rotateAngleX = f;
            model.wisps.rotateAngleY = 0;
        };
        BiConsumer<ModelIronShade, Float> bodyBender = (model, f) -> model.body.rotateAngleX = f;
    ...
    private static final SoundEvent[] ambient = new SoundEvent[]{ModSoundEvents.ENTITY_IRON_SHADE_AMBIENT1,ModSoundEvents.ENTITY_IRON_SHADE_AMBIENT2,ModSoundEvents.ENTITY_IRON_SHADE_AMBIENT3};
    private static final SoundEvent[] hurt = new SoundEvent[]{ModSoundEvents.ENTITY_IRON_SHADE_HURT1,ModSoundEvents.ENTITY_IRON_SHADE_HURT2,ModSoundEvents.ENTITY_IRON_SHADE_HURT3};
    private static final SoundEvent[] death = new SoundEvent[]{ModSoundEvents.ENTITY_IRON_SHADE_DEATH1,ModSoundEvents.ENTITY_IRON_SHADE_DEATH2,ModSoundEvents.ENTITY_IRON_SHADE_DEATH3};
