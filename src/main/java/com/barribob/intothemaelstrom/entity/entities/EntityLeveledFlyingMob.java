...
import com.barribob.intothemaelstrom.util.IAnimatedMob;
 ...
 */
public abstract class EntityLeveledFlyingMob<T extends ModelBase> extends EntityFlying implements IMob, IRangedAttackMob, IAnimatedMob<T>, IElement {
