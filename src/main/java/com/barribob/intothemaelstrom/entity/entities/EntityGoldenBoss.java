...
import com.barribob.intothemaelstrom.entity.action.*;
import com.barribob.intothemaelstrom.entity.adjustment.MovingRuneAdjustment;
import com.barribob.intothemaelstrom.entity.adjustment.RandomRuneAdjustment;
...
import com.barribob.intothemaelstrom.util.RenderUtils;
...
public class EntityGoldenBoss extends EntityMaelstromMob implements IAttack {
    ...
    Supplier<ProjectileEntity> goldenMissile = () -> new ProjectileEntityGoldenMissile(world, this, this.getAttack() * getConfigDouble("golden_missile_damage"));
    Supplier<ProjectileEntity> maelstromMissile = () -> new ProjectileEntityStatueMaelstromMissile(world, this, this.getAttack() * getConfigDouble("maelstrom_missile_damage"));
    Supplier<ProjectileEntity> goldenRune = () -> new EntityLargeGoldenRune(this.world, this, this.getAttack() * getConfigDouble("golden_rune_damage"));
    ...
    Supplier<ProjectileEntity> maelstromOrGoldenMissile = () -> rand.nextInt(2) == 0 ? goldenMissile.get() : maelstromMissile.get();
    ...
    private final Consumer<EntityLivingBase> volleyAttack = target -> {
        ...
        Supplier<ProjectileEntity> projectileSupplier = isSecondPhase() ? maelstromOrGoldenMissile : goldenMissile;
    ...
    private static final SoundEvent[] ambient = new SoundEvent[]{ModSoundEvents.ENTITY_GOLDEN_BOSS_AMBIENT1,ModSoundEvents.ENTITY_GOLDEN_BOSS_AMBIENT2,ModSoundEvents.ENTITY_GOLDEN_BOSS_AMBIENT3};
    private static final SoundEvent[] hurt = new SoundEvent[]{ModSoundEvents.ENTITY_GOLDEN_BOSS_HURT1,ModSoundEvents.ENTITY_GOLDEN_BOSS_HURT2,ModSoundEvents.ENTITY_GOLDEN_BOSS_HURT3};
    private static final SoundEvent[] death = new SoundEvent[]{ModSoundEvents.ENTITY_GOLDEN_BOSS_DEATH1,ModSoundEvents.ENTITY_GOLDEN_BOSS_DEATH2,ModSoundEvents.ENTITY_GOLDEN_BOSS_DEATH3};
