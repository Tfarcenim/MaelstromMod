...
public class LaserAction implements IGauntletAction{
    ...
    public void doAction() {
        ...
        entity.playSound(ModSoundEvents.ENTITY_MAELSTROM_GAUNTLET_LAZER_CHARGE, 2.0f, ModRandom.getFloat(0.2f) + 1.5f);
        int chargeUpTime = 25;
        int laserEndTime = 60;
                ...
                entity.addEvent(() -> {
                    ...
                    for (Entity target : ModUtils.findEntitiesInLine(entity.getPositionEyes(1), lazerPos, entity.world, entity)) {
                        DamageSource source = ModDamageSource.builder()
                                ...
                                .build();
                        target.attackEntityFrom(source, (float) (entity.getAttack() * entity.getConfigDouble("laser_damage")));
                    }
