...
public class EntityMaelstromBeast extends EntityMaelstromMob implements IAttack {
    ...
    Runnable spawnQuake = () -> {
        ProjectileEntity projectile = this.isRaged() ?
                new ProjectileEntityBoneQuake(world, this, this.getAttack() * getConfigDouble("bone_hammer_wave_damage")) :
                new ProjectileEntityBeastQuake(world, this, this.getAttack() * getConfigDouble("hammer_wave_damage"));
    ...
    private final Consumer<EntityLivingBase> swipe = target -> {
        ...
        addEvent(() -> {
            ...
            double damage = this.getAttack() * getConfigDouble("swipe_damage");
    ...
    public final Consumer<EntityLivingBase> spray = target -> {
        ...
        addEvent(() -> {
            ...
            ModUtils.lineCallback(targetPos.add(axis), targetPos.subtract(axis), 5, (pos, i) -> {
                ProjectileEntity projectile = new ProjectileEntityBeastFireball(world, this, this.getAttack() * getConfigDouble("high_leap_fireball_damage"));
    ...
    private static final SoundEvent[] ambient = new SoundEvent[]{ModSoundEvents.ENTITY_MAELSTROM_BEAST_AMBIENT1,ModSoundEvents.ENTITY_MAELSTROM_BEAST_AMBIENT2,ModSoundEvents.ENTITY_MAELSTROM_BEAST_AMBIENT3};
    private static final SoundEvent[] hurt = new SoundEvent[]{ModSoundEvents.ENTITY_MAELSTROM_BEAST_HURT1,ModSoundEvents.ENTITY_MAELSTROM_BEAST_HURT2,ModSoundEvents.ENTITY_MAELSTROM_BEAST_HURT3};
    private static final SoundEvent[] death = new SoundEvent[]{ModSoundEvents.ENTITY_MAELSTROM_BEAST_DEATH1,ModSoundEvents.ENTITY_MAELSTROM_BEAST_DEATH2,ModSoundEvents.ENTITY_MAELSTROM_BEAST_DEATH3};
