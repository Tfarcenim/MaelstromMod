...
public class ModArmorBase extends ItemArmor implements ILeveledItem, IElement {
    ...
    public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        if (!this.armorBonusDesc.isEmpty() && IntoTheMaelstrom.itemsConfig.getBoolean("full_set_bonuses." + armorBonusDesc.replace("_full_set", ""))) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
        if (this.getCustomModel() != null) {
            return IntoTheMaelstrom.MOD_ID + ":textures/models/armor/" + this.textureName;
        }
        ...
        return String.format("%s:textures/models/armor/%s_layer_%d%s.png", IntoTheMaelstrom.MOD_ID, this.textureName, layer, t);
    }
