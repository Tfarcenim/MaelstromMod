...
import com.barribob.intothemaelstrom.entity.projectile.ProjectileEntityPiercingBullet;
...
public class ItemPiercer extends ItemGun {
    ...
    protected void shoot(World world, EntityPlayer player, EnumHand handIn, ItemStack stack) {
        ...
        ProjectileEntity projectile = new ProjectileEntityPiercingBullet(world, player, this.getEnchantedDamage(stack), stack);
